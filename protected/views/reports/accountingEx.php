  ...
  <?php endforeach;?>
      ...
      <table width=200px;>
        <tr>
          ...
          <td colspan=<?=count($data['passenger'][$d8])+1?> bgcolor=#92d050><center><?=date('l, F d, Y',strtotime($d8))?></center></td>
          <?php endforeach;?>
        </tr>
        <tr>
      ...
      <th>Total Load Factor</th>
        ...
        <tr>
          <th class="bold space">VEHICLES FREIGHT</th>
          <td class="space" colspan=<?=$col['count']?>>&nbsp;</td>
        </tr>
        <tr>
          <th bgcolor=#92d050>Date</th>
