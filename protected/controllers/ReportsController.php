  ...
  class ReportsController extends Controller{
    ...
    public function actionRevenue(){
      ...
      if(isset($_POST['ReportForm'])){
        ...
        $sql = "SELECT $select,vessel,voyage,sum(total_rev) total_rev,sum(business_rev) business_rev,sum(premium_rev) premium_rev,sum(cargo_rev) cargo_rev FROM voyage_report $where GROUP BY $group ORDER BY departure_date";
    ...
    public function actionAccounting($excel=null){
      ...
      if(isset($_GET['ReportForm'])){
        ...
        $sql="SELECT voyage,departure_date,SUM(amt) amt,seating_class length FROM cargo_history $where GROUP BY departure_date,voyage_id,id";
