...
/**
 * This is the model class for table "cargo_history".
 *
 * The followings are the available columns in table 'cargo_history':
 * @property integer $id
 ...
 * @property string $amt
 */
class CargoHistory extends CActiveRecord
{
	/**
	 ...
	 * @return CargoHistory the static model class
	 */
